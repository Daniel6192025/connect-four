...
public class Constants
{
    ...
    // Valid board values
    public static final int RED = -1;    // Indicates an "RED"
    public static final int BLACK = 1;     // Indicates an "BLACK"
    public static final int BLANK = 0; // Indicates a blank square

    // Game states
    public static final int STANDBY = 0;
    public static final int GET_RED_NAME = 1;
    public static final int GET_BLACK_NAME = 2;
    public static final int GET_RED_MOVE = 3;
    public static final int GET_BLACK_MOVE = 4;
